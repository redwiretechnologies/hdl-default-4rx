...
# default_block_0 -> AD9361_0

ad_connect default_block_0/adc_overflow axi_ad9361_0/adc_dovf
ad_connect default_block_0/dac_underflow axi_ad9361_0/dac_dunf

# default_block_0 <-> concat_0

ad_connect concat_9361_0/adc_data default_block_0/adc_data
ad_connect concat_9361_0/adc_enable default_block_0/adc_enable
ad_connect concat_9361_0/adc_valid default_block_0/adc_valid

ad_connect default_block_0/dac_data concat_9361_0/dac_data
ad_connect concat_9361_0/dac_enable default_block_0/dac_enable
ad_connect concat_9361_0/dac_valid default_block_0/dac_valid

# DAC_DMA_0 -> default_block_0

ad_connect axi_ad9361_dac_dma_0/m_axis default_block_0/s_dac_dma

# default_block_0 -> ADC_DMA_0

ad_connect default_block_0/m_adc_dma axi_ad9361_adc_dma_0/s_axis

# default_block_1 -> AD9361_1

ad_connect default_block_1/adc_overflow axi_ad9361_1/adc_dovf
ad_connect default_block_1/dac_underflow axi_ad9361_1/dac_dunf

# default_block_1 <-> concat_1

ad_connect concat_9361_1/adc_data default_block_1/adc_data
ad_connect concat_9361_1/adc_enable default_block_1/adc_enable
ad_connect concat_9361_1/adc_valid default_block_1/adc_valid

ad_connect default_block_1/dac_data concat_9361_1/dac_data
ad_connect concat_9361_1/dac_enable default_block_1/dac_enable
ad_connect concat_9361_1/dac_valid default_block_1/dac_valid

# DAC_DMA_1 -> default_block_1

ad_connect axi_ad9361_dac_dma_1/m_axis default_block_1/s_dac_dma

# default_block_1 -> ADC_DMA_1

ad_connect default_block_1/m_adc_dma axi_ad9361_adc_dma_1/s_axis
...
ad_connect axi_ad9361_0/l_clk default_block_0/adc_clk
ad_connect axi_ad9361_0/l_clk default_block_0/dac_clk
...
ad_connect adc_clk_reset/peripheral_aresetn default_block_0/adc_rstn
ad_connect adc_clk_reset/peripheral_aresetn default_block_0/dac_rstn
...
ad_connect axi_ad9361_1/l_clk default_block_1/adc_clk
ad_connect axi_ad9361_1/l_clk default_block_1/dac_clk
...
ad_connect adc_clk_reset/peripheral_aresetn default_block_1/adc_rstn
ad_connect adc_clk_reset/peripheral_aresetn default_block_1/dac_rstn
